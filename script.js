...
document.getElementById('download').addEventListener('click', function() {
    console.log("hey");
    downloadCanvas(document.getElementById("downloadLink"), 'downloadMaze', 'maze.png');
}, false);

pathWidth = 80      //Width of the Maze Path
wall = 4             //Width of the Walls between Paths
outerWall = 6        //Width of the Outer most wall
width = 6           //Number paths fitted horisontally
height = 3          //Number paths fitted vertically
